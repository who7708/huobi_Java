...
public class TestMarketDataWs2 {
    ...
    public void readFile() throws IOException {
        ...
        final String path = this.getClass().getResource("/symbols.json").getPath();
    ...
    public void test1() throws InterruptedException, IOException {
        ...
        // 交易对
        final InputStream symbolInputStream = this.getClass().getResourceAsStream("/symbols.json");
        ...
        final InputStream tickerInputStream = this.getClass().getResourceAsStream("/tickers.json");
    ...
    public void test2() {
        ...
        //         .size(10)
        //         .build());
        // System.out.println(JSON.toJSONString(candlestick));
